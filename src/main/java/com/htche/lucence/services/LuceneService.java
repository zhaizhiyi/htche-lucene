package com.htche.lucence.services;
...
public class LuceneService {
	...
	private volatile static LuceneService singleton;
	...
	public IndexReader getIndexReader(Directory dir,boolean enableNRTReader)
	{
	   ...
	   * @param executor 如果你需要开启多线程查询，请提供ExecutorService对角参数
	   * @return
	   */
